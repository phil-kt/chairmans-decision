...
init -1 python hide:
    ...
    config.window_title = u"The Chairman's Decision"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "The Chairman's Decision"
    config.version = "1.0"
...
python early:
    config.save_directory = "The Chairman's Decision-1429551158"
...
init python:
    ...
    build.directory_name = "TheChairman'sDecision-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "The Chairman's Decision"
